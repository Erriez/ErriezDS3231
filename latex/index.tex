...
{\bfseries E\+S\+P32 problem\+:} The Arduino I\+DE $\vert$ Board manager installs an old version {\ttfamily 1.\+0.\+0} from {\ttfamily \href{https://dl.espressif.com/dl/package_esp32_index.json}{\tt https\+://dl.\+espressif.\+com/dl/package\+\_\+esp32\+\_\+index.\+json}} which contains a broken I2C repeated start. Generating a repeated start with {\ttfamily Wire.\+end\+Transmission(false);} results in reading zero\textquotesingle{}s from any I2C device and is not a problem of this library.
